...
public class MainActivity extends BaseMainSlide{
    ...
    @Bind(R.id.floatingActionButton_inform)
    FloatingActionButton addInformFloatingButton;
    @Bind(R.id.floatingActionButton_share)
    ...
    public void mainInitFloatBar(){
        ...
        floatingDraftButton.registerButton(addInformFloatingButton);
        floatingDraftButton.registerButton(shareFloatingButton);
...
//    }
    ...
    public void mainAddPJFragment(){
        ...
        //开启一个Fragment事务
        fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.main_menu_content, partJobFragment,"partjob");
        fragmentTransaction.commit();
    }
    //引入底部菜单
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        int topartjob = intent.getIntExtra("toPartJob",0);
        ...
        if(topartjob == 1){
            navigation = (BottomNavigationView) findViewById(R.id.navigation);
            navigation.setSelectedItemId(R.id.navigation_partjob);
            mainAddPJFragment();
