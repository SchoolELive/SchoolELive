...
import com.xiaoyu.schoolelive.util.ScreenUtil;

import java.util.ArrayList;


public class CustomFloatingDraftButton extends FloatingActionButton implements View.OnTouchListener{
    ...
    public CustomFloatingDraftButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomFloatingDraftButton(Context context, AttributeSet attrs, int defStyleAttr) {
