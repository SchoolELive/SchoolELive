...
public class CustomMailLineView extends View {
    ...
    public CustomMailLineView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CustomMailLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomMailLineView(Context context) {
        super(context);
    }
