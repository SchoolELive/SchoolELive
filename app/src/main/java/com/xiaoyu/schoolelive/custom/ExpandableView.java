...
public class ExpandableView extends LinearLayout implements ExpandleItemView.OnExpandItemClick {
     ...
     * toggleButton正常的字体颜色
     */
    int mNormalTextColor = getResources().getColor(R.color.hint_color);

    /**
     * toggleButton被选中的类型字体颜色
     */
    //int mSelectTextColor = Color.BLUE;
    ...
    private void showPopWindow() {
        ...
        if (mPopupWindow.isShowing()) {
            ...
            /** 显示的时候，设为选中颜色 */
            mSelectToggleBtn.setTextColor(getResources().getColor(R.color
                    .themecolor));
