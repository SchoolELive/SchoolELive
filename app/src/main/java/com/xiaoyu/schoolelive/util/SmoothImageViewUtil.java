...
public class SmoothImageViewUtil extends android.support.v7.widget.AppCompatImageView {
    ...
    public SmoothImageViewUtil(Context context) {
        super(context);
        init();
    }

    public SmoothImageViewUtil(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SmoothImageViewUtil(Context context, AttributeSet attrs, int defStyle) {
